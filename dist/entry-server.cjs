...
var TWEAK_DEFAULTS = (
  /*EDITMODE-BEGIN*/
  { "heroOverlay": 20, "accentColor": "#c9a96e", "darkForm": false }
);
function useTweaks(defaults) {
  const [values, setValues] = (0, import_react.useState)(defaults);
  const setTweak = (0, import_react.useCallback)((k, v) => {
...
function TweaksPanel({ title, children }) {
  ...
  if (!open) return null;
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("style", null, TWEAKS_CSS), /* @__PURE__ */ import_react.default.createElement("div", { ref, className: "twk-panel" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-hd" }, /* @__PURE__ */ import_react.default.createElement("b", null, title || "Tweaks"), /* @__PURE__ */ import_react.default.createElement("button", { className: "twk-x", onClick: dismiss }, "\u2715")), /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-body" }, children)));
}
function TweakSection({ label }) {
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-sect" }, label);
}
function TweakSlider({ label, tweakKey, min, max, step, tweaks, setTweak }) {
  const val = tweaks[tweakKey];
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-row" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-lbl" }, /* @__PURE__ */ import_react.default.createElement("span", null, label), /* @__PURE__ */ import_react.default.createElement("span", { className: "twk-val" }, val)), /* @__PURE__ */ import_react.default.createElement("input", { type: "range", className: "twk-slider", min, max, step: step || 1, value: val, onChange: (e) => setTweak(tweakKey, Number(e.target.value)) }));
}
function TweakColor({ label, tweakKey, tweaks, setTweak }) {
  const val = tweaks[tweakKey];
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-row twk-row-h" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "twk-lbl" }, /* @__PURE__ */ import_react.default.createElement("span", null, label)), /* @__PURE__ */ import_react.default.createElement("input", { type: "color", className: "twk-swatch", value: val, onChange: (e) => setTweak(tweakKey, e.target.value) }));
}
...
function TreeLine({ opacity = 0.07, dark = "#0a1a0a" }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("svg", { style: { position: "absolute", bottom: 0, left: 0, width: "100%", height: "40%", pointerEvents: "none" }, viewBox: "0 0 1440 260", preserveAspectRatio: "xMidYMax meet" }, trees.map(([x, h], i) => {
    const w = h * 0.48;
    return /* @__PURE__ */ import_react.default.createElement("g", { key: i, opacity }, /* @__PURE__ */ import_react.default.createElement("polygon", { points: `${x},260 ${x + w / 2},${260 - h} ${x + w},260`, fill: dark }), /* @__PURE__ */ import_react.default.createElement("rect", { x: x + w / 2 - 4, y: 255 - 20, width: 8, height: 24, fill: dark }));
  }));
}
function CTAButton({ label, variant = "gold", style: extra, onClick, type = "button", interest }) {
  const openModal = (0, import_react.useContext)(ModalCtx);
  ...
  return /* @__PURE__ */ import_react.default.createElement("button", { type, style: { ...base, ...v[variant] }, onMouseEnter: () => setHov(true), onMouseLeave: () => setHov(false), onClick: handleClick }, label);
}
function PopupModal({ isOpen, onClose, defaultInterest }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-overlay", onClick: (e) => {
    if (e.target === e.currentTarget) onClose();
  } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-box" }, /* @__PURE__ */ import_react.default.createElement("div", { style: { padding: "32px 36px 28px", borderBottom: "1px solid rgba(26,46,26,0.1)", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 20, background: "#1a2e1a" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.28em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 8 } }, "Begin Your Journey"), /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(22px,2.5vw,30px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.2 } }, "Your forest home", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "awaits a conversation."))), /* @__PURE__ */ import_react.default.createElement("button", { onClick: onClose, style: { background: "none", border: "none", color: "rgba(245,240,232,0.55)", fontSize: 22, cursor: "pointer", lineHeight: 1, flexShrink: 0, padding: "4px" } }, "\u2715")), /* @__PURE__ */ import_react.default.createElement("div", { style: { padding: "28px 36px 36px" } }, done ? /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", padding: "36px 20px" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 48, color: "#c9a96e", marginBottom: 16, animation: "float 3s ease-in-out infinite" } }, "\u2726"), /* @__PURE__ */ import_react.default.createElement("h4", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 26, fontWeight: 300, color: "#1a2e1a", marginBottom: 12 } }, "Thank you, ", form.name.split(" ")[0], "."), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(26,46,26,0.6)", lineHeight: 1.85, marginBottom: 24 } }, "Our team will reach out within 24 hours to schedule your private visit to Aranya."), /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
...
function Nav() {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("nav", { style: { position: "fixed", top: 0, left: 0, right: 0, zIndex: 500, height: 80, padding: "0 clamp(20px,5vw,72px)", display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled || menuOpen ? "rgba(10,19,10,0.98)" : "rgba(10,19,10,0.75)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", borderBottom: `1px solid rgba(201,169,110,${scrolled || menuOpen ? "0.3" : "0.12"})`, transition: "background 0.4s ease, border-color 0.4s ease" } }, /* @__PURE__ */ import_react.default.createElement("a", { href: "#hero", style: { textDecoration: "none", display: "flex", alignItems: "center", zIndex: 510 }, onClick: () => setMenuOpen(false) }, /* @__PURE__ */ import_react.default.createElement("img", { src: "uploads/asset 1@3x.webp", alt: "Aranya by Rang Homes", style: { height: 56, width: "auto", objectFit: "contain", filter: "brightness(0) saturate(100%) invert(72%) sepia(42%) saturate(480%) hue-rotate(2deg) brightness(98%) contrast(90%)" } })), /* @__PURE__ */ import_react.default.createElement("div", { className: "nav-links-desktop" }, links.map(([href, label]) => /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
      key: href,
      href,
      className: "gold-line",
      style: { color: "rgba(245,240,232,0.75)", textDecoration: "none", fontFamily: "DM Sans", fontSize: 11, fontWeight: 400, letterSpacing: "0.08em", textTransform: "uppercase", transition: "color 0.3s", paddingBottom: 4 },
      onMouseEnter: (e) => {
        e.currentTarget.style.color = "#c9a96e";
      },
      onMouseLeave: (e) => {
    ...
    {
      onClick: () => openModal(""),
      style: { color: "#c9a96e", border: "1px solid #c9a96e", padding: "9px 22px", background: "transparent", fontFamily: "DM Sans", fontSize: 11, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", transition: "all 0.3s", cursor: "pointer" },
      onMouseEnter: (e) => {
        e.currentTarget.style.background = "#c9a96e";
        e.currentTarget.style.color = "#1a2e1a";
      },
    ...
    "Enquire"
  )), /* @__PURE__ */ import_react.default.createElement("button", { className: "nav-hamburger", onClick: toggleMenu, style: { background: "none", border: "none", color: "#c9a96e", fontSize: 24, padding: 8, cursor: "pointer", zIndex: 510 } }, menuOpen ? "\u2715" : "\u2630")), /* @__PURE__ */ import_react.default.createElement("div", { className: `nav-drawer ${menuOpen ? "open" : ""}` }, links.map(([href, label]) => /* @__PURE__ */ import_react.default.createElement("a", { key: href, href, onClick: () => setMenuOpen(false) }, label)), /* @__PURE__ */ import_react.default.createElement("button", { onClick: () => {
    setMenuOpen(false);
    openModal("");
  }, style: { color: "#1a2e1a", background: "#c9a96e", border: "none", padding: "12px 32px", fontFamily: "DM Sans", fontSize: 12, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", transition: "all 0.3s", cursor: "pointer", marginTop: 12 } }, "Enquire Now")));
}
function Hero({ tweaks }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "hero", style: { position: "relative", width: "100%", height: "100vh", minHeight: 680, overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: `url('uploads/shot_07_5kshot_07_5k.webp')`, backgroundSize: "cover", backgroundPosition: "center 40%", transform: `translateY(${scrollY * 0.35}px)`, willChange: "transform" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: `linear-gradient(to bottom, rgba(8,18,8,0.6) 0%, rgba(8,18,8,0.32) 50%, rgba(8,18,8,0.75) 100%)` } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: `rgba(5,12,5,${ov})` } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "relative", zIndex: 2, textAlign: "center", padding: "0 clamp(20px,5vw,60px)", maxWidth: 980, opacity: ready ? 1 : 0, transition: "opacity 1.1s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 28, animation: ready ? "fadeUp 1.2s ease 0.1s both" : "none" } }, "RANG HOMES AEROCITY, DHARAPUR, GUWAHATI, ASSAM"), /* @__PURE__ */ import_react.default.createElement("h1", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(40px,5.5vw,80px)", fontWeight: 300, lineHeight: 1.12, color: "#f5f0e8", letterSpacing: "-0.01em", marginBottom: 28, opacity: ready ? 1 : 0, transform: ready ? "translateY(0)" : "translateY(28px)", transition: "opacity 1.1s ease 0.2s, transform 1.1s ease 0.2s" } }, "Your Sanctuary", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e", fontStyle: "italic" } }, "of Senses.")), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 15, fontWeight: 300, color: "rgba(245,240,232,0.7)", letterSpacing: "0.06em", lineHeight: 2, maxWidth: 440, margin: "0 auto 52px", animation: ready ? "fadeUp 1.1s ease 0.45s both" : "none" } }, "Spacious 2,3 & 4 BHK Apartments"), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", animation: ready ? "fadeUp 1.1s ease 0.6s both" : "none" } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Schedule a Visit", variant: "gold", interest: "" }), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "View Gallery", variant: "outline", onClick: () => {
    const el = document.getElementById("gallery");
    if (el) el.scrollIntoView({ behavior: "smooth" });
  } }))), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 32, left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: 8, opacity: ready ? 0.5 : 0, transition: "opacity 2s ease 1.2s" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.28em", color: "#f5f0e8", textTransform: "uppercase" } }, "Scroll"), /* @__PURE__ */ import_react.default.createElement("div", { style: { width: 1, height: 44, background: "linear-gradient(to bottom, #c9a96e, transparent)", animation: "scrollPulse 2s ease-in-out infinite" } })));
}
function StatsBar() {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { ref, className: "stats-grid", style: { background: "#1a2e1a", padding: "clamp(36px,5vw,64px) clamp(20px,5vw,80px)" } }, stats.map((s, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, className: "stats-item hover-lift", style: { textAlign: "center", padding: "12px 16px", opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(18px)", transition: `opacity 0.7s ease ${i * 0.08}s, transform 0.7s ease ${i * 0.08}s`, cursor: "default" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,3.5vw,46px)", fontWeight: 300, color: "#c9a96e", lineHeight: 1 } }, s.n), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "DM Sans", fontSize: 10, fontWeight: 400, color: "rgba(245,240,232,0.5)", letterSpacing: "0.14em", textTransform: "uppercase", marginTop: 10 } }, s.l))));
}
function Manifesto() {
  const [ref, vis] = useReveal(0.12);
  const pRef = useParallax(0.18);
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "manifesto", style: { padding: "clamp(72px,9vw,130px) clamp(20px,8vw,130px)", background: "#f5f0e8", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", right: "-2%", top: "45%", transform: "translateY(-50%)", fontFamily: "Cormorant Garamond, serif", fontSize: "min(260px,22vw)", fontWeight: 300, color: "rgba(26,46,26,0.04)", lineHeight: 1, userSelect: "none", pointerEvents: "none", letterSpacing: "-0.02em" } }, "Aranya"), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1140, margin: "0 auto" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "manifesto-grid", style: { gap: "clamp(40px,6vw,96px)", alignItems: "center", marginBottom: "clamp(48px,6vw,80px)" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { opacity: vis ? 1 : 0, transform: vis ? "translateX(0)" : "translateX(-28px)", transition: "opacity 0.9s ease, transform 0.9s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "The Vision"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,3.8vw,52px)", fontWeight: 300, lineHeight: 1.18, color: "#1a2e1a", marginBottom: 28 } }, "Where the forest", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", null, "breathes you in.")), /* @__PURE__ */ import_react.default.createElement(GoldDivider, { style: { maxWidth: 220, marginBottom: 24 } }), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "#7a9e7e", marginBottom: 32 } }, "RANG HOMES AEROCITY, DHARAPUR, GUWAHATI"), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Book a Site Visit", variant: "outlineDark", interest: "" })), /* @__PURE__ */ import_react.default.createElement("div", { style: { opacity: vis ? 1 : 0, transform: vis ? "translateX(0)" : "translateX(28px)", transition: "opacity 0.9s ease 0.18s, transform 0.9s ease 0.18s" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(18px,2vw,24px)", fontWeight: 300, fontStyle: "italic", lineHeight: 1.8, color: "#2a3a2a", marginBottom: 28 } }, '"A home that quietens the mind. Sunlit rooms, open corridors, and a community woven through greenery \u2014 every element of Aranya is designed to restore what urban life slowly takes away."'), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, lineHeight: 1.95, color: "#4a5a4a", marginBottom: 22 } }, "Nestled within RH Aerocity's emerging residential landscape, Aranya rises from 70% open green land. Two towers. 257 homes. A single quiet conviction \u2014 that living well means living close to nature."), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, lineHeight: 1.95, color: "#4a5a4a" } }, "Here, you don't escape to nature on weekends. ", /* @__PURE__ */ import_react.default.createElement("em", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 18, color: "#1a2e1a" } }, "You wake up inside it.")))), /* @__PURE__ */ import_react.default.createElement("div", { ref: pRef, className: "img-zoom", style: { overflow: "hidden", opacity: vis ? 1 : 0, transition: "opacity 0.9s ease 0.35s", position: "relative" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { height: 400, overflow: "hidden", position: "relative" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "parallax-inner", style: { position: "absolute", inset: "-15% 0", backgroundImage: `url('uploads/entrance cam_rang homes.webp')`, backgroundSize: "cover", backgroundPosition: "center" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 16, left: 16, background: "rgba(10,20,10,0.65)", border: "1px solid rgba(245,240,232,0.2)", padding: "5px 12px", zIndex: 3 } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "#f5f0e8", fontWeight: 400 } }, "Artist's Impression"))))));
}
function SustainableAtmos() {
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "wellness", style: { background: "#1a2e1a", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", top: 0, right: 0, width: "45%", height: "65%", background: "radial-gradient(ellipse at top right, rgba(122,158,126,0.11) 0%, transparent 70%)", pointerEvents: "none" } }), /* @__PURE__ */ import_react.default.createElement(TreeLine, { opacity: 0.06, dark: "#060e06" }), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1180, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginBottom: 68, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease, transform 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "Sustainable Atmos"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,56px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.15 } }, "A pathway to tranquility,", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "surrounded by nature's embrace."))), /* @__PURE__ */ import_react.default.createElement("div", { className: "sustainable-grid", style: { gap: 3, marginBottom: 3 } }, [
  ...
  ].map((z, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, className: "img-zoom", style: { position: "relative", height: 420, overflow: "hidden", opacity: vis ? 1 : 0, transition: `opacity 0.75s ease ${0.2 + i * 0.12}s`, cursor: "pointer" }, onClick: () => {
  } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: `url('${z.img}')`, backgroundSize: "cover", backgroundPosition: "center" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(5,15,5,0.9) 0%, rgba(5,15,5,0.1) 55%)" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 0, left: 0, right: 0, padding: "clamp(28px,3vw,40px)" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.24em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 10 } }, z.sub), /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 28, fontWeight: 400, color: "#f5f0e8", marginBottom: 12 } }, z.title), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(245,240,232,0.72)", lineHeight: 1.75 } }, z.desc))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", padding: "48px 0 0", opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.5s" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(245,240,232,0.38)", marginBottom: 22 } }, "Landscape Highlights"), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center", marginBottom: 40 } }, tags.map((t, i) => /* @__PURE__ */ import_react.default.createElement(
    "span",
    {
      key: i,
      style: { fontFamily: "DM Sans", fontSize: 12, fontWeight: 300, color: "rgba(245,240,232,0.65)", padding: "8px 18px", border: "1px solid rgba(201,169,110,0.18)", transition: "all 0.3s", cursor: "default" },
      onMouseEnter: (e) => {
    ...
    t
  ))), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Explore Life at Aranya", variant: "outline", interest: "" }))));
}
function WellnessSection() {
  ...
  const groups = [
    ...
    { cat: "Social & Community", items: ["Club Aranya \u2014 16,000 sq ft", "Rooftop Social Lounge", "Double-Height Banquet Hall", "Open Caf\xE9 & Restaurant", "Mini Theatre"] },
    { cat: "For Families", items: ["EIEIO Play Studio", "Outdoor Kids' Play Area", "Floating Cabana", "Stargazing Deck", "Senior Seating Grove"] }
  ];
  return /* @__PURE__ */ import_react.default.createElement("section", { style: { background: "#f5f0e8", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1180, margin: "0 auto" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "wellness-main-grid", style: { gap: "clamp(40px,5vw,80px)", alignItems: "start" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "sticky", top: 100, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease, transform 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "Holistic Wellness"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px,3.2vw,46px)", fontWeight: 300, lineHeight: 1.2, color: "#1a2e1a", marginBottom: 24 } }, "Step into serenity.", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", null, "Every day.")), /* @__PURE__ */ import_react.default.createElement(GoldDivider, { style: { maxWidth: 180, marginBottom: 22 } }), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "#4a5a4a", lineHeight: 1.9, marginBottom: 32 } }, "Whether a morning swim, an evening walk through the butterfly garden, or a quiet hour at the caf\xE9 \u2014 every moment at Aranya feels unhurried."), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Explore Club Aranya", variant: "outlineDark", onClick: () => {
    const el = document.getElementById("club");
    if (el) el.scrollIntoView({ behavior: "smooth" });
  } })), /* @__PURE__ */ import_react.default.createElement("div", { className: "wellness-cards-grid", style: { gap: 3 } }, groups.map((g, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, className: "hover-lift", style: { background: i % 2 === 0 ? "#ede7d9" : "#e6dfd1", padding: "clamp(24px,3vw,36px) clamp(20px,2.5vw,32px)", opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: `opacity 0.7s ease ${0.1 + i * 0.1}s, transform 0.7s ease ${0.1 + i * 0.1}s` } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "#7a9e7e", marginBottom: 16 } }, g.cat), /* @__PURE__ */ import_react.default.createElement("ul", { style: { listStyle: "none" } }, g.items.map((item, j) => /* @__PURE__ */ import_react.default.createElement("li", { key: j, style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "#2a3a2a", padding: "7px 0", display: "flex", alignItems: "center", gap: 10, borderBottom: j < g.items.length - 1 ? "1px solid rgba(26,46,26,0.07)" : "none" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { width: 4, height: 4, borderRadius: "50%", background: "#c9a96e", flexShrink: 0 } }), item)))))))));
}
function ClubAranya() {
  const [ref, vis] = useReveal(0.1);
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "club", style: { background: "#243a24", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", top: "-10%", left: "50%", transform: "translateX(-50%)", width: "70%", height: "55%", background: "radial-gradient(ellipse, rgba(201,169,110,0.07) 0%, transparent 70%)", pointerEvents: "none" } }), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1180, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginBottom: 56, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("img", { src: "uploads/logo design.webp", alt: "Club Aranya Logo", style: { width: 80, height: 80, objectFit: "contain", marginBottom: 20, border: "1px solid rgba(201,169,110,0.3)", padding: "4px", background: "rgba(255,255,255,0.05)", boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.2)" } }), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 22, fontWeight: 500, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "Club Aranya"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,56px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.15, marginBottom: 18 } }, "Double-tiered social spaces", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "spread over 16,000+ sq ft.")), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "rgba(245,240,232,0.55)", maxWidth: 520, margin: "0 auto", lineHeight: 1.85 } }, "Social, inclusive, rooted in warmth \u2014 this is where unwinding hours feel special.")), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 3, marginBottom: 3, flexWrap: "wrap", justifyContent: "center" } }, spaces.map((s, i) => /* @__PURE__ */ import_react.default.createElement("button", { key: i, onClick: () => setActive(i), style: { fontFamily: "DM Sans", fontSize: 11, fontWeight: 400, letterSpacing: "0.08em", textTransform: "uppercase", padding: "11px 18px", border: "none", cursor: "pointer", background: active === i ? "#c9a96e" : "rgba(245,240,232,0.07)", color: active === i ? "#1a2e1a" : "rgba(245,240,232,0.55)", transition: "all 0.25s ease", flex: "0 0 auto" } }, s.name))), /* @__PURE__ */ import_react.default.createElement("div", { className: "club-grid", style: { gap: 3, opacity: vis ? 1 : 0, transition: "opacity 0.7s ease 0.25s" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { background: "rgba(245,240,232,0.04)", border: "1px solid rgba(201,169,110,0.15)", padding: "clamp(32px,4vw,56px) clamp(28px,4vw,52px)", display: "flex", flexDirection: "column", justifyContent: "center" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "#7a9e7e", marginBottom: 16 } }, spaces[active].tag), /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,3.5vw,46px)", fontWeight: 300, color: "#f5f0e8", marginBottom: 22, lineHeight: 1.15 } }, spaces[active].name), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "rgba(245,240,232,0.68)", lineHeight: 1.9 } }, spaces[active].desc)), /* @__PURE__ */ import_react.default.createElement("div", { className: "img-zoom", style: { height: 380, overflow: "hidden", position: "relative" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: `url('${spaces[active].img}')`, backgroundSize: "cover", backgroundPosition: "center", transition: "background-image 0.2s" } }))), /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginTop: 36, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.5s" } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "View Full Gallery", variant: "outline", onClick: () => {
    const el = document.getElementById("gallery");
    if (el) el.scrollIntoView({ behavior: "smooth" });
  } }))));
}
function HomesSection() {
  const [ref, vis] = useReveal(0.1);
  const [active, setActive] = (0, import_react.useState)(0);
  const [activeSub, setActiveSub] = (0, import_react.useState)(0);
  const [isPlanZoomed, setIsPlanZoomed] = (0, import_react.useState)(false);
  const [planZoomOrigin, setPlanZoomOrigin] = (0, import_react.useState)("50% 50%");
  (0, import_react.useEffect)(() => {
    setActiveSub(0);
  ...
  const units = [
    ...
    },
    {
      ...
      size: "1,326 \u2013 1,687",
      unit: "sq ft",
      floors: "Ground to 10th Floor",
      tag: "Executive Choice",
      price: "\u20B95,200 \u2013 \u20B96,200 /sq ft",
      planImg: "uploads/unit-a.webp",
    ...
    {
      type: "3 BHK + 3T + Terrace",
      label: "Garden Homes",
      size: "2,280 \u2013 2,687",
      unit: "sq ft",
      floors: "1st & 2nd Floor",
      tag: "Limited Edition",
      price: "\u20B95,500 \u2013 \u20B96,500 /sq ft",
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "homes", style: { background: "#f5f0e8", padding: "clamp(72px,9vw,120px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginBottom: 52, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 16 } }, "Celestial Apartments"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,52px)", fontWeight: 300, color: "#1a2e1a", lineHeight: 1.15 } }, "Curated, comfortable,", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", null, "consciously designed."))), /* @__PURE__ */ import_react.default.createElement("div", { className: "homes-tabs", style: { marginBottom: 3, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.1s" } }, units.map((u2, i) => /* @__PURE__ */ import_react.default.createElement("button", { key: i, onClick: () => setActive(i), style: { padding: "16px 12px", border: "none", cursor: "pointer", textAlign: "left", transition: "all 0.3s", background: active === i ? "#1a2e1a" : "#ede7d9", borderBottom: active === i ? "2px solid #c9a96e" : "2px solid transparent" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 12, letterSpacing: "0.16em", textTransform: "uppercase", color: active === i ? "#c9a96e" : "#7a9e7e", marginBottom: 5 } }, u2.type), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 24, fontWeight: 400, color: active === i ? "#f5f0e8" : "#1a2e1a", lineHeight: 1.2 } }, u2.label), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: "#c9a96e", marginTop: 6 } }, u2.tag)))), u.subtabs && u.subtabs.length > 0 && /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
    ...
    u.subtabs.map((sub, idx) => /* @__PURE__ */ import_react.default.createElement("button", { key: idx, onClick: () => setActiveSub(idx), style: {
      padding: "10px 6px",
      border: "none",
      cursor: "pointer",
      textAlign: "center",
      ...
      if (idxOpen !== -1) {
        ...
        return /* @__PURE__ */ import_react.default.createElement("span", { style: { display: "block", overflow: "hidden", textOverflow: "ellipsis" } }, base, " ", /* @__PURE__ */ import_react.default.createElement("span", { style: {
          fontSize: "10px",
          fontWeight: 400,
          opacity: 0.85,
          textTransform: "none",
  ...
  ), /* @__PURE__ */ import_react.default.createElement("div", { key: active + "-" + activeSub, className: "homes-main-grid", style: { gap: 3, animation: "fadeIn 0.4s ease", opacity: vis ? 1 : 0, transition: "opacity 0.6s ease 0.2s" } }, /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      style: {
        background: "#fff",
    ...
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(122,158,126,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(122,158,126,0.04) 1px,transparent 1px)", backgroundSize: "24px 24px", pointerEvents: "none" } }),
    /* @__PURE__ */ import_react.default.createElement(
      "img",
      {
        src: currentPlanImg,
    ...
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", top: 16, left: 16, background: "#1a2e1a", padding: "6px 14px" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#c9a96e" } }, u.subtabs && u.subtabs[activeSub] ? u.subtabs[activeSub].name : `${u.type} \xB7 ${u.label}`)),
    /* @__PURE__ */ import_react.default.createElement("p", { style: { position: "absolute", bottom: 12, right: 14, fontFamily: "DM Sans", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(26,46,26,0.3)" } }, "Indicative Floor Plan \u2014 Not to Scale")
  ), /* @__PURE__ */ import_react.default.createElement("div", { style: { background: "#1a2e1a", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "clamp(28px,3.5vw,48px) clamp(24px,3vw,40px)" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 12, letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 8 } }, u.type), /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px,3vw,40px)", fontWeight: 300, color: "#f5f0e8", marginBottom: 6, lineHeight: 1.1 } }, u.subtabs && u.subtabs[activeSub] ? `${u.label === "Garden Home" ? "Garden Homes" : u.label}_ ${u.subtabs[activeSub].name}` : u.label), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,240,232,0.35)", marginBottom: 28 } }, u.tag), (() => {
    const currentCarpet = u.subtabs && u.subtabs[activeSub] && u.subtabs[activeSub].carpet ? u.subtabs[activeSub].carpet : u.carpet;
    const currentSize = u.subtabs && u.subtabs[activeSub] && u.subtabs[activeSub].size ? u.subtabs[activeSub].size : u.size;
    const currentFloors = u.subtabs && u.subtabs[activeSub] && u.subtabs[activeSub].floors ? u.subtabs[activeSub].floors : u.floors;
    const currentTower = u.subtabs && u.subtabs[activeSub] && u.subtabs[activeSub].tower ? u.subtabs[activeSub].tower : u.tower;
    const stats = [
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "homes-stats-grid", style: {
      display: "grid",
      gridTemplateColumns: "repeat(2, 1fr)",
      gap: 3,
      marginBottom: 28
    } }, stats.map(([k, v], i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, style: {
      ...
      marginBottom: 5
    } }, k), /* @__PURE__ */ import_react.default.createElement("p", { style: {
  ...
  })(), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(245,240,232,0.4)", marginBottom: 12 } }, "Highlights"), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 0, marginBottom: 28 } }, (u.subtabs && u.subtabs[activeSub] && u.subtabs[activeSub].hl ? u.subtabs[activeSub].hl : u.hl).map((h, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 12, padding: "9px 0", borderBottom: "1px solid rgba(245,240,232,0.06)", fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "rgba(245,240,232,0.78)" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { width: 5, height: 5, borderRadius: "50%", background: "#c9a96e", flexShrink: 0 } }), h)))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: `Enquire \u2014 ${u.subtabs && u.subtabs[activeSub] ? u.subtabs[activeSub].name : u.label}`, variant: "gold", interest: u.interest }), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Download Brochure", variant: "outline", interest: u.interest }))))));
}
function WalkthroughVideo() {
  const [ref, vis] = useReveal(0.1);
  const [playing, setPlaying] = (0, import_react.useState)(false);
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "walkthrough", style: { background: "#1a2e1a", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement(TreeLine, { opacity: 0.05, dark: "#060e06" }), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1e3, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginBottom: 52, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease, transform 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "Virtual Walkthrough"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,52px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.15 } }, "Experience Aranya", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "before you walk in."))), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "relative", paddingBottom: "56.25%", height: 0, background: "rgba(0,0,0,0.5)", border: "1px solid rgba(201,169,110,0.2)", opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.25s" } }, playing ? /* @__PURE__ */ import_react.default.createElement("iframe", { style: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", border: "none" }, src: "https://www.youtube.com/embed/0xOfYiOB6iM?autoplay=1", title: "Aranya Walkthrough", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true }) : /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, onClick: () => setPlaying(true) }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: `url('uploads/club cam_rang homes_rev.webp')`, backgroundSize: "cover", backgroundPosition: "center" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: "rgba(5,15,5,0.58)" } }), /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      style: { position: "relative", zIndex: 1, width: 80, height: 80, borderRadius: "50%", background: "rgba(201,169,110,0.92)", display: "flex", alignItems: "center", justifyContent: "center", animation: "pulse 2.5s ease-in-out infinite", transition: "transform 0.3s" },
      onMouseEnter: (e) => {
    ...
    /* @__PURE__ */ import_react.default.createElement("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "#1a2e1a" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M8 5v14l11-7z" }))
  ), /* @__PURE__ */ import_react.default.createElement("p", { style: { position: "relative", zIndex: 1, fontFamily: "DM Sans", fontSize: 12, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(245,240,232,0.75)" } }, "Play Walkthrough Video"))), /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginTop: 40, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.5s" } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Schedule an In-Person Tour", variant: "gold", interest: "" }))));
}
function GallerySection() {
  ...
  const thumbsRef = (0, import_react.useRef)(null);
  const images = [
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "gallery", style: { background: "#f5f0e8", padding: "clamp(64px,8vw,100px) clamp(20px,8vw,120px)" } }, /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1180, margin: "0 auto" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginBottom: 40, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 14 } }, "Gallery"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,52px)", fontWeight: 300, color: "#1a2e1a", lineHeight: 1.15, marginBottom: 28 } }, "See it. Feel it.", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "Believe it.")), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 3, justifyContent: "center", flexWrap: "wrap" } }, cats.map((c) => /* @__PURE__ */ import_react.default.createElement("button", { key: c, onClick: () => setFilter(c), style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", padding: "8px 20px", border: "none", cursor: "pointer", background: filter === c ? "#1a2e1a" : "rgba(26,46,26,0.08)", color: filter === c ? "#c9a96e" : "rgba(26,46,26,0.55)", transition: "all 0.25s" } }, c)))), /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      style: { position: "relative", width: "100%", aspectRatio: "16/9", overflow: "hidden", cursor: "pointer", opacity: vis ? 1 : 0, transition: "opacity 0.9s ease 0.2s", border: "1px solid rgba(201,169,110,0.1)" },
      onClick: () => setLightbox(Math.min(current, filtered.length - 1))
    },
    filtered.map((im, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: im.src, style: { position: "absolute", inset: 0, backgroundImage: `url('${im.src}')`, backgroundSize: "cover", backgroundPosition: "center", opacity: i === current ? 1 : 0, transition: "opacity 0.6s ease" } })),
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(8,18,8,0.8) 0%, transparent 45%, rgba(8,18,8,0.1) 100%)", pointerEvents: "none" } }),
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 0, left: 0, right: 0, padding: "clamp(20px,3vw,36px) clamp(20px,3vw,36px)", display: "flex", alignItems: "flex-end", justifyContent: "space-between", pointerEvents: "none" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 5 } }, img.cat), /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(20px,2.5vw,32px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.2 } }, img.label)), /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(22px,3vw,42px)", fontWeight: 300, color: "rgba(201,169,110,0.5)", lineHeight: 1 } }, String(current + 1).padStart(2, "0"), /* @__PURE__ */ import_react.default.createElement("span", { style: { fontSize: "0.45em", color: "rgba(245,240,232,0.25)", margin: "0 5px" } }, "/"), String(filtered.length).padStart(2, "0"))),
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", top: 20, right: 20, background: "rgba(0,0,0,0.4)", border: "1px solid rgba(201,169,110,0.25)", padding: "6px 12px", display: "flex", alignItems: "center", gap: 7, pointerEvents: "none" } }, /* @__PURE__ */ import_react.default.createElement("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "#c9a96e", strokeWidth: "2" }, /* @__PURE__ */ import_react.default.createElement("circle", { cx: "11", cy: "11", r: "8" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "21", y1: "21", x2: "16.65", y2: "16.65" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "11", y1: "8", x2: "11", y2: "14" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "8", y1: "11", x2: "14", y2: "11" })), /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(245,240,232,0.55)" } }, "Expand")),
    [["\u2190", () => goTo((c) => (c - 1 + filtered.length) % filtered.length), "left:16px"], ["\u2192", () => goTo((c) => (c + 1) % filtered.length), "right:16px"]].map(([a, fn, pos], idx) => /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        key: idx,
        onClick: (e) => {
        ...
        style: { position: "absolute", top: "50%", transform: "translateY(-50%)", [pos.split(":")[0]]: pos.split(":")[1], width: 44, height: 44, background: "rgba(201,169,110,0.15)", border: "1px solid rgba(201,169,110,0.3)", color: "#c9a96e", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.25s", zIndex: 2 },
        onMouseEnter: (e) => e.currentTarget.style.background = "rgba(201,169,110,0.35)",
        onMouseLeave: (e) => e.currentTarget.style.background = "rgba(201,169,110,0.15)"
      },
      a
    )),
    /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 0, left: 0, right: 0, height: 2, background: "rgba(201,169,110,0.15)" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { height: "100%", background: "#c9a96e", width: `${(current + 1) / filtered.length * 100}%`, transition: "width 0.4s ease" } }))
  ), /* @__PURE__ */ import_react.default.createElement("div", { ref: thumbsRef, style: { display: "flex", gap: 3, overflowX: "auto", padding: "3px 0", scrollbarWidth: "none", opacity: vis ? 1 : 0, transition: "opacity 0.9s ease 0.35s" } }, filtered.map((im, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: im.src, onClick: () => goTo(i), style: { flexShrink: 0, width: 100, height: 64, backgroundImage: `url('${im.src}')`, backgroundSize: "cover", backgroundPosition: "center", cursor: "pointer", opacity: i === current ? 1 : 0.42, border: i === current ? "2px solid #c9a96e" : "2px solid transparent", transition: "all 0.3s" } }))), /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", marginTop: 36, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.5s" } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Request Full Brochure", variant: "dark", interest: "" }))), lightbox !== null && /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 9e3, background: "rgba(5,12,5,0.97)", display: "flex", alignItems: "center", justifyContent: "center" }, onClick: (e) => {
    if (e.target === e.currentTarget) setLightbox(null);
  } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "relative", maxWidth: "92vw", maxHeight: "90vh", animation: "lightboxIn 0.28s ease" } }, /* @__PURE__ */ import_react.default.createElement("img", { src: filtered[lightbox].src, alt: filtered[lightbox].label, style: { maxWidth: "92vw", maxHeight: "84vh", objectFit: "contain", display: "block" } }), /* @__PURE__ */ import_react.default.createElement("p", { style: { textAlign: "center", fontFamily: "DM Sans", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(245,240,232,0.5)", marginTop: 14 } }, filtered[lightbox].label, " \xA0\xB7\xA0 ", lightbox + 1, " / ", filtered.length)), /* @__PURE__ */ import_react.default.createElement(
    "button",
    {
      onClick: () => setLightbox((l) => (l - 1 + filtered.length) % filtered.length),
      style: { position: "fixed", top: "50%", left: 24, transform: "translateY(-50%)", background: "rgba(201,169,110,0.15)", border: "1px solid rgba(201,169,110,0.3)", color: "#c9a96e", width: 48, height: 48, fontSize: 20, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" },
    ...
    "button",
    {
      ...
      style: { position: "fixed", top: "50%", right: 24, transform: "translateY(-50%)", background: "rgba(201,169,110,0.15)", border: "1px solid rgba(201,169,110,0.3)", color: "#c9a96e", width: 48, height: 48, fontSize: 20, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" },
      onMouseEnter: (e) => e.currentTarget.style.background = "rgba(201,169,110,0.3)",
      onMouseLeave: (e) => e.currentTarget.style.background = "rgba(201,169,110,0.15)"
    },
    "\u2192"
  ), /* @__PURE__ */ import_react.default.createElement("button", { onClick: () => setLightbox(null), style: { position: "fixed", top: 20, right: 24, background: "none", border: "none", color: "rgba(245,240,232,0.6)", fontSize: 28, cursor: "pointer", lineHeight: 1 } }, "\u2715")));
}
function LocationSection() {
  ...
  const categories = [
    {
      cat: "Education",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#c9a96e", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M22 10v6M2 10l10-5 10 5-10 5z" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M6 12v5c3 3 9 3 12 0v-5" })),
      color: "#a8c5ab",
      items: [
    ...
    {
      cat: "Healthcare",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#d4a5a0", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M22 12h-4l-3 9L9 3l-3 9H2" })),
      color: "#d4a5a0",
      items: [
        { n: "Garal PHC", d: "950 m" },
        { n: "Azara PHC", d: "3.8 km" },
        { n: "Guwahati University Hospital", d: "10.7 km" },
        { n: "Apollo Excelcare Hospital", d: "13.2 km" }
      ]
    },
    {
      cat: "Connectivity",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#c9a96e", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v3" }), /* @__PURE__ */ import_react.default.createElement("rect", { x: "9", y: "11", width: "14", height: "10", rx: "2" }), /* @__PURE__ */ import_react.default.createElement("circle", { cx: "12", cy: "16", r: "1" })),
      color: "#c9a96e",
      items: [
        { n: "International Airport", d: "4.7 km" },
        { n: "Dharapur Chariali", d: "2.2 km" },
        { n: "Jalukbari Flyover", d: "10 km" },
        { n: "BCPL Fuel Station", d: "650 m" }
      ]
    },
    {
      cat: "Universities",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#a8c5ab", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" }), /* @__PURE__ */ import_react.default.createElement("polyline", { points: "9 22 9 12 15 12 15 22" })),
      color: "#a8c5ab",
      items: [
        { n: "Girijananda Chowdhury University", d: "2.9 km" },
        { n: "Assam Don Bosco University", d: "3.2 km" },
        { n: "Guwahati University", d: "5.4 km" },
        { n: "Cotton University", d: "12 km" }
      ]
    },
    {
      cat: "Lifestyle",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#7a9e7e", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "3", y1: "6", x2: "21", y2: "6" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M16 10a4 4 0 0 1-8 0" })),
      color: "#7a9e7e",
      items: [
        { n: "University Shopping Complex", d: "6.6 km" },
        { n: "Decathlon Azara", d: "6.7 km" },
        { n: "NCS Square Mall", d: "9.0 km" },
        { n: "Kiranshree Grand Hotel", d: "3.7 km" }
      ]
    },
    {
      cat: "Recreation",
      icon: /* @__PURE__ */ import_react.default.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#c9b8a8", strokeWidth: "1.8" }, /* @__PURE__ */ import_react.default.createElement("circle", { cx: "12", cy: "12", r: "10" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M12 8v4l3 3" })),
      color: "#c9b8a8",
      items: [
        { n: "Brahmaputra River Banks", d: "8.2 km" },
        { n: "Srimanta Sankardev Kalakshetra", d: "9.4 km" },
        { n: "Nehru Park", d: "10.1 km" },
        { n: "Umananda Island", d: "11.6 km" }
      ]
    }
  ];
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "location", style: { background: "#1a2e1a", padding: "clamp(72px,9vw,120px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement(TreeLine, { opacity: 0.04, dark: "#0b1a0b" }), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1180, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "location-header-grid", style: { gap: "clamp(32px,5vw,72px)", alignItems: "end", marginBottom: 56, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease, transform 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 16 } }, "Location"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(32px,4vw,52px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.15 } }, "At the heart of", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "everything that matters."))), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(245,240,232,0.55)", lineHeight: 1.9, marginBottom: 24 } }, "Located in Aerocity's rapidly developing residential belt on Dharapur- Palashbari Road, the perfect confluence of urban conveniences and an escape into nature."), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Get Directions", variant: "outline", onClick: () => {
    window.location.href = googleMapsUrl;
  } })))), /* @__PURE__ */ import_react.default.createElement("div", { className: "location-map-grid", style: { gap: 3, marginBottom: 3, opacity: vis ? 1 : 0, transition: "opacity 0.85s ease 0.2s" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "relative", minHeight: 320, overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement(
    "iframe",
    {
      ...
      title: "Aranya Location"
    }
  ), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, zIndex: 2, cursor: "pointer" }, onClick: () => {
    window.location.href = googleMapsUrl;
  } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -100%)", pointerEvents: "none", zIndex: 3, display: "flex", flexDirection: "column", alignItems: "center" } }, /* @__PURE__ */ import_react.default.createElement("svg", { width: "32", height: "32", viewBox: "0 0 24 24", fill: "none", stroke: "#ff0000", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z", fill: "#ff0000" }), /* @__PURE__ */ import_react.default.createElement("circle", { cx: "12", cy: "10", r: "3", fill: "#faf8f3" })), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 34, left: "50%", transform: "translateX(-50%)", background: "rgba(10,20,10,0.92)", border: "1px solid rgba(201,169,110,0.35)", padding: "6px 10px", whiteSpace: "nowrap" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.16em", textTransform: "uppercase", color: "#c9a96e" } }, "Aranya by Rang Homes Phase-1"))), /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", bottom: 16, left: 16, background: "rgba(10,20,10,0.92)", border: "1px solid rgba(201,169,110,0.35)", padding: "10px 16px", zIndex: 2 } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.16em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 3 } }, "ARANYA BY RANG HOMES PHASE 1"), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 11, fontWeight: 300, color: "rgba(245,240,232,0.65)" } }, "4JM6+R77, Azara, Guwahati, Assam 781017"))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 } }, [
    { v: "4.7 KM", l: "Airport", c: "#c9a96e" },
    { v: "2.2 km", l: "Nearest School", c: "#a8c5ab" },
    { v: "950 m", l: "PHC", c: "#d4a5a0" },
    { v: "70%", l: "Green Cover", c: "#7a9e7e" }
  ].map((s, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, style: { background: "rgba(245,240,232,0.04)", border: "1px solid rgba(201,169,110,0.12)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "28px 16px", textAlign: "center" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px,3vw,38px)", fontWeight: 300, color: s.c, lineHeight: 1, marginBottom: 8 } }, s.v), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(245,240,232,0.38)" } }, s.l))))), /* @__PURE__ */ import_react.default.createElement("div", { className: "location-cats-grid", style: { gap: 3, opacity: vis ? 1 : 0, transition: "opacity 0.85s ease 0.35s" } }, categories.map((cat, ci) => /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      key: ci,
      style: { background: "rgba(245,240,232,0.03)", border: "1px solid rgba(201,169,110,0.1)", padding: "28px 28px 24px", transition: "background 0.3s" },
    ...
    /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, marginBottom: 20, paddingBottom: 16, borderBottom: "1px solid rgba(201,169,110,0.12)" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { width: 40, height: 40, borderRadius: "50%", background: "rgba(245,240,232,0.06)", border: `1.5px solid ${cat.color}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, cat.icon), /* @__PURE__ */ import_react.default.createElement("h4", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 22, fontWeight: 400, fontStyle: "italic", color: "#f5f0e8", lineHeight: 1 } }, cat.cat)),
    /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 0 } }, cat.items.map((p, pi) => /* @__PURE__ */ import_react.default.createElement("div", { key: pi, style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 0", borderBottom: pi < cat.items.length - 1 ? "1px solid rgba(245,240,232,0.05)" : "none" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 12, fontWeight: 300, color: "rgba(245,240,232,0.7)", lineHeight: 1.4, flex: 1, paddingRight: 12 } }, p.n), /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 10, fontWeight: 500, color: cat.color, background: `rgba(${cat.color === "#c9a96e" ? "201,169,110" : "122,158,126"},0.12)`, padding: "3px 9px", letterSpacing: "0.06em", flexShrink: 0, whiteSpace: "nowrap" } }, p.d))))
  )))));
}
function DeveloperSection() {
  ...
  return /* @__PURE__ */ import_react.default.createElement("section", { style: { background: "#ede7d9", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { ref, className: "developer-grid", style: { maxWidth: 1180, margin: "0 auto", gap: "clamp(40px,5vw,80px)", alignItems: "center" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease, transform 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 20 } }, "About the Developer"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px,3.5vw,48px)", fontWeight: 300, color: "#1a2e1a", lineHeight: 1.2, marginBottom: 26 } }, "Built on integrity.", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", null, "Delivered with precision.")), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "#4a5a4a", lineHeight: 1.9, marginBottom: 18 } }, "Indotech Infracon Private Limited \u2014 the force behind Aranya by Rang Homes Phase 1 - has shaped the residential landscape of Guwahati over the years, delivering 600+ homes that stand as long-term assets for their residents."), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 14, fontWeight: 300, color: "#4a5a4a", lineHeight: 1.9, marginBottom: 36 } }, "Every project reflects a quiet conviction: quality must be consistent, details deliberate, and every home must honour the trust placed in it."), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 36, flexWrap: "wrap", marginBottom: 36 } }, [["600+", "Homes Delivered"], ["8+", "Years of Trust"]].map(([v, l], i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 40, fontWeight: 300, color: "#1a2e1a", lineHeight: 1 } }, v), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a9e7e", marginTop: 6 } }, l)))), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Speak to the Team", variant: "dark", interest: "" })), /* @__PURE__ */ import_react.default.createElement("div", { style: { opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(22px)", transition: "opacity 0.8s ease 0.2s, transform 0.8s ease 0.2s" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#7a9e7e", marginBottom: 20 } }, "Delivered Projects"), projects.map((p, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 0", borderBottom: i < projects.length - 1 ? "1px solid rgba(26,46,26,0.1)" : "none" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 22, fontWeight: 400, color: "#1a2e1a" } }, p.name), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "DM Sans", fontSize: 11, fontWeight: 300, color: "#6b6b6b", marginTop: 3 } }, p.loc)), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a9e7e", border: "1px solid #7a9e7e", padding: "6px 12px", flexShrink: 0 } }, "Delivered"))), /* @__PURE__ */ import_react.default.createElement("div", { style: { marginTop: 36, padding: "24px 28px", background: "#1a2e1a" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 14 } }, "Design Team"), [["Principal Architect", "Confluence Consultancy Services, Delhi"], ["Landscape", "S.P Consultants, Delhi"], ["MEP", "AEPL, Delhi"], ["Structural", "Swati Structure Solutions Pvt. Ltd, Delhi"], ["Local Architect", "Banka & Associates, Guwahati"]].map(([r, f], i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, style: { display: "flex", justifyContent: "space-between", padding: "6px 0", borderBottom: i < 4 ? "1px solid rgba(245,240,232,0.06)" : "none" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 12, fontWeight: 300, color: "rgba(245,240,232,0.45)" } }, r), /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "DM Sans", fontSize: 12, fontWeight: 400, color: "rgba(245,240,232,0.82)" } }, f)))))));
}
function FAQSection() {
  const [ref, vis] = useReveal(0.08);
  ...
  const faqs = [
    ...
    { q: "What are the key amenities?", a: "Club Aranya spans 16,000+ sq ft including a swimming pool, gym, gaming room, EIEIO kids' studio, banquet hall, rooftop lounge, caf\xE9, mini theatre, and multiple themed gardens." },
  ...
  const FaqItem = ({ faq, i, globalIdx }) => /* @__PURE__ */ import_react.default.createElement("div", { style: { borderBottom: "1px solid rgba(201,169,110,0.12)" } }, /* @__PURE__ */ import_react.default.createElement("button", { onClick: () => setOpen(open === globalIdx ? null : globalIdx), style: { width: "100%", background: "none", border: "none", cursor: "pointer", padding: "18px 0", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, textAlign: "left" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(15px,1.6vw,18px)", fontWeight: 400, color: open === globalIdx ? "#c9a96e" : "#f5f0e8", transition: "color 0.3s", lineHeight: 1.35, flex: 1 } }, faq.q), /* @__PURE__ */ import_react.default.createElement("span", { style: { color: "#c9a96e", fontSize: 18, flexShrink: 0, transition: "transform 0.3s", transform: open === globalIdx ? "rotate(45deg)" : "rotate(0deg)", display: "block", lineHeight: 1, marginTop: 2 } }, "+")), /* @__PURE__ */ import_react.default.createElement("div", { style: { maxHeight: open === globalIdx ? "200px" : "0", overflow: "hidden", transition: "max-height 0.4s ease" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(245,240,232,0.6)", lineHeight: 1.85, paddingBottom: 18, paddingRight: 28 } }, faq.a)));
  return /* @__PURE__ */ import_react.default.createElement("section", { id: "faq", style: { background: "#1a2e1a", padding: "clamp(72px,9vw,130px) clamp(20px,8vw,120px)", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "absolute", inset: 0, background: "radial-gradient(ellipse 55% 70% at 50% 50%, rgba(201,169,110,0.05) 0%, transparent 70%)", pointerEvents: "none" } }), /* @__PURE__ */ import_react.default.createElement(TreeLine, { opacity: 0.045, dark: "#070f07" }), /* @__PURE__ */ import_react.default.createElement("div", { ref, style: { maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "faq-main-grid", style: { gap: "clamp(40px,5vw,80px)", alignItems: "start", opacity: vis ? 1 : 0, transition: "opacity 0.8s ease" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { position: "sticky", top: 100 } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#c9a96e", marginBottom: 16 } }, "FAQ"), /* @__PURE__ */ import_react.default.createElement("h2", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px,3.2vw,42px)", fontWeight: 300, color: "#f5f0e8", lineHeight: 1.2, marginBottom: 22 } }, "Questions", /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("em", { style: { color: "#c9a96e" } }, "answered.")), /* @__PURE__ */ import_react.default.createElement(GoldDivider, { style: { maxWidth: 160, marginBottom: 24 } }), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(245,240,232,0.5)", lineHeight: 1.85, marginBottom: 28 } }, "Can't find what you're looking for? Our team is happy to help."), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Ask Us Anything", variant: "outline", interest: "" })), /* @__PURE__ */ import_react.default.createElement("div", { className: "faq-cols-grid", style: { gap: "0 40px", opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.2s" } }, /* @__PURE__ */ import_react.default.createElement("div", null, col1.map((faq, i) => /* @__PURE__ */ import_react.default.createElement(FaqItem, { key: i, faq, i, globalIdx: i }))), /* @__PURE__ */ import_react.default.createElement("div", null, col2.map((faq, i) => /* @__PURE__ */ import_react.default.createElement(FaqItem, { key: i, faq, i, globalIdx: i + half }))))), /* @__PURE__ */ import_react.default.createElement("div", { style: { marginTop: 56, padding: "40px 44px", background: "rgba(201,169,110,0.07)", border: "1px solid rgba(201,169,110,0.18)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, flexWrap: "wrap", opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.4s" } }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h3", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(20px,2.5vw,28px)", fontWeight: 300, color: "#f5f0e8", marginBottom: 6 } }, "Still have questions?"), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 13, fontWeight: 300, color: "rgba(245,240,232,0.5)" } }, "Our team is happy to walk you through anything.")), /* @__PURE__ */ import_react.default.createElement(CTAButton, { label: "Speak to Our Team", variant: "gold", onClick: () => window.open("https://wa.me/919311852020", "_blank") }))));
}
function Footer() {
  const openModal = (0, import_react.useContext)(ModalCtx);
  return /* @__PURE__ */ import_react.default.createElement("footer", { style: { background: "#0b160b", padding: "36px clamp(20px,8vw,120px)" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { maxWidth: 1180, margin: "0 auto" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24, marginBottom: 32 } }, /* @__PURE__ */ import_react.default.createElement("img", { src: "uploads/asset 1@3x.webp", alt: "Aranya by Rang Homes", style: { height: 52, objectFit: "contain", filter: "brightness(0) saturate(100%) invert(72%) sepia(42%) saturate(480%) hue-rotate(2deg) brightness(98%) contrast(90%)" } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", gap: 24, flexWrap: "wrap" } }, [["#manifesto", "Vision"], ["#wellness", "Life"], ["#club", "Club"], ["#homes", "Homes"], ["#gallery", "Gallery"], ["#location", "Location"], ["#faq", "FAQ"]].map(([h, l]) => /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
      key: h,
      href: h,
      style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,240,232,0.38)", textDecoration: "none", transition: "color 0.3s" },
      onMouseEnter: (e) => e.currentTarget.style.color = "#c9a96e",
      onMouseLeave: (e) => e.currentTarget.style.color = "rgba(245,240,232,0.38)"
    },
    l
  )), /* @__PURE__ */ import_react.default.createElement("button", { onClick: () => openModal(""), style: { fontFamily: "DM Sans", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#c9a96e", background: "none", border: "none", cursor: "pointer", padding: 0 } }, "Enquire"))), /* @__PURE__ */ import_react.default.createElement(GoldDivider, { style: { marginBottom: 24 } }), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 16, alignItems: "flex-start" } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 10, fontWeight: 300, color: "rgba(245,240,232,0.22)", lineHeight: 1.7, maxWidth: 660 } }, "RERA Registration: Under Process. Possession: 2031. Views are artist's impressions only. Information is indicative and subject to change without notice. This does not constitute an offer. Indotech Infracon Pvt. Ltd. \xA9 2026."), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "Cormorant Garamond, serif", fontSize: 16, fontStyle: "italic", color: "rgba(201,169,110,0.32)", flexShrink: 0 } }, '"The whistling winds are getting greener."')), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, borderTop: "1px solid rgba(245,240,232,0.06)", paddingTop: 16, marginTop: 16 } }, /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, fontWeight: 300, color: "rgba(245,240,232,0.18)", lineHeight: 1.6 } }, /* @__PURE__ */ import_react.default.createElement("strong", null, "Disclaimer:"), " The floor plans are as per the approved plans and specifications as of date. These plans may vary by +/- 3% and are subject to changes. The furniture, accessories, etc. shown in the plans does not form a part of the offering. Customers are requested to visit the site office and apprise themselves of all the necessary details prior to making any purchase decisions. Any decorative item and furniture shown in any unit/private terrace/private area are not a part of our offering. This is just to give an idea of how the unit can be utilized in the best possible way."), /* @__PURE__ */ import_react.default.createElement("p", { style: { fontFamily: "DM Sans", fontSize: 9, fontWeight: 300, color: "rgba(245,240,232,0.18)", lineHeight: 1.6 } }, "Views & photographs used in this brochure are artist\u2019s impression for illustration purpose only. The information, features, offerings and other details herein are only indicative and the developer/owner reserves its right to change any or all of these in its discretion subject to grant of approval from relevant authorities. This printed material does not constitute an offer, an invitation to an offer and/or commitment of any nature between the developer/owner and recipients. The developer\u2019s/owner\u2019s website(s) and other advertising and publicity material include artist\u2019s impression indicating the anticipated appearance of completed development. No warranty is given that the completed development will comply in any degree with such artist\u2019s impression. Costs, designs, facilities and/or specifications may be subject to change without notice."))));
}
function App() {
...
// src/entry-server.jsx
function render() {
  return (0, import_server.renderToString)(/* @__PURE__ */ import_react2.default.createElement(App_default, null));
}
var entry_server_default = render;
